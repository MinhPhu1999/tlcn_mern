...
module.exports = (app) => {
    //product
    app.route('/admin/addproduct').post(
        upload.single('file'),
        admin_controller.addProduct
    );
    // app.route('/admin/updateprice')
    //     .post(upload.single('file'),admin_controller.addProductTest);
    app.route('/admin/updateproduct').put(
        upload.single('file'),
    ...
    app.route('/admin/order/quantitybyyear/:year').get(
        order_controller.getQuantityByYear
    );
    app.route('/admin/order/yearandcategory').post(
        order_controller.getQuantityByYearAndCategory
    );
    app.route('/admin/order/countorder').post(
        order_controller.getQuantityOrderByYearAndCategory
    );
